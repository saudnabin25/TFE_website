...
export default function Home(){
  return (
    <>
      <section className="relative h-[70vh] min-h-[480px] flex items-center justify-center text-white bg-brand">
        <img src="/Pictures/landing.jpeg" alt="Trinket For Education" className="absolute inset-0 w-full h-full object-cover" />
